...
<body>
	<form action="../controladores/controlador_opciones.php" method="POST">
		<input type="hidden" name="acciones" value="modificar_opcion">
		<div class="container">
			<div class="form-group separador-md">
				<div class="bg-primary text-center titulo text-uppercase">Editar Opciones</div>
			</div>	

			<div class="form-group separador-md">
				<div class="col-md-3 col-sm-3">
					<label for="id_ope">Codigo Operacion:</label>
				</div>
				<div class="col-md-9 col-sm-9">
					<?php $objUtilidades->hacer_lista_desplegable($conexion,$tabla="operaciones",$value="id_ope",$mostrar="nom_ope",$nombre="fk_ope","",$funcion="mostrar_datos_opciones()"); ?>
				</div>
			</div>
			...
			<div class="form-group separador-md">
				...
				<div class="col-md-9 col-sm-9">
					<input type="radio" name="est_ope" id="est_ope1" value="A">Activo
